...
<template>
  <div class="flex flex-col items-end gap-1">
    <div class="text-xl font-semibold text-slate-700 tabular-nums">{{ current }} / {{ total }}</div>
    <span
    ...
    >
      ...
      <!-- Trophy (done) -->
      <svg v-else class="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path
          d="M7 4h10v3a5 5 0 01-10 0V4zM4 5h2v2a3 3 0 003 3v2H8a4 4 0 01-4-4V5zm16 0v3a4 4 0 01-4 4h-1v-2a3 3 0 003-3V5h2zM10 13h4l-.5 3H14v2h-4v-2h.5L10 13zm-2 7h8v2H8v-2z"
        />
      </svg>
